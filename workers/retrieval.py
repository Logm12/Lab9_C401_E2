...
def _get_embedding_fn():
    """
    Trả về embedding function sử dụng OpenAI (TIP-007).
    Sử dụng model text-embedding-3-small để tối ưu tốc độ và độ chính xác.
    """
    from openai import OpenAI
    # Đảm bảo có API Key trong môi trường
    ...
    def embed(text: str) -> list:
        try:
            ...
            import random
            return [random.random() for _ in range(1536)] # text-embedding-3-small has 1536 dims
